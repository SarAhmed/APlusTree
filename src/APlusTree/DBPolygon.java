...
public class DBPolygon implements Comparable<DBPolygon>, Serializable {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof DBPolygon))
			return false;
		DBPolygon dbPolygon = (DBPolygon) o;
		return Arrays.equals(dbPolygon.polygon.ypoints, this.polygon.ypoints)
				&& Arrays.equals(dbPolygon.polygon.xpoints, this.polygon.xpoints)
				&& dbPolygon.polygon.npoints == (this.polygon.npoints);
	}
	...
	/*
	 * @Override public boolean equals(Object o) { DBPolygon q=(DBPolygon)o; return
	 * this.compareTo(q)==0; }
	 */
	public String toString() {
		...
		for (int i = 0; i < x.length; i++)
			r += "(" + x[i] + " ," + y[i] + " ) ";
		r += " with area "
				+ (this.polygon.getBounds().getSize().getWidth() * this.polygon.getBounds().getSize().getHeight());
